...
import { ExternalLinkIcon, GithubIcon, LocationIcon, MailIcon } from './Icons'
import { SectionHeader } from './SectionHeader'

export function ContactSlide() {
  return (
    <section
      className="relative flex min-h-svh items-center px-[72px] pb-12 pt-32 max-[1200px]:px-9 max-[980px]:px-[18px] max-[980px]:pb-[92px] max-[980px]:pt-9"
      aria-label="Contact"
    >
        ...
        <div className="grid gap-4 max-[560px]:gap-3">
          ...
          <InfoCard title="Location">
            <p className="inline-flex min-h-0 w-fit max-w-full items-center gap-3 break-words rounded-lg font-sans text-base font-extrabold text-[#374151] no-underline hover:text-[#1A73E8] max-[560px]:text-[0.95rem]">
              <LocationIcon className="size-5 fill-none stroke-current [stroke-linecap:round] [stroke-linejoin:round] [stroke-width:2]" />
